        ...
        return /* html */ `
            ...
            <footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
                <div class="md:flex md:justify-between">
                    ...
                    <img src="../../images/logo.png" class="mr-4 h-10" alt=" Logo">
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Garena</span>
                    </a>
                </div>
                ...
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" target="_blank" class="hover:underline">LuvCii™</a>. All Rights Reserved.
                </span>
