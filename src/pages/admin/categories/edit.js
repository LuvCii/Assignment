...
const AdminCateEdit = {
    async render(id) {
        ...
        <div class="min-h-full">
            ...
            <main>
              <form class="" id="form-edit-cate">
                <div class="bg-indigo-50 min-h-screen md:px-20 pt-6">
                  <div class=" bg-white rounded-md px-6 py-10 max-w-[1000px] mx-auto">
                    <h1 class="text-center text-2xl font-bold text-gray-500 mb-10">EDIT CATE</h1>
                    <div class="space-y-4">
                      <div>
                        <label for="title" class="text-lx font-serif">Category:</label>
                        <input required value="${data.cate}" type="text" placeholder="title" name="type" id="type" class="ml-2 outline-none py-1 px-2 text-md border-2 rounded-md" />
                      </div>
                     ...
                     <img src="${data.img}" class="mx-auto mt-3 w-52 mb-3 object-cover rounded-md" id="img-preview"/>
                      <button class="mt-4 px-6 py-2 mx-auto block rounded-md text-lg font-semibold text-indigo-100 bg-indigo-600  ">EDIT CATEGORY</button>
                    </div>
                  </div>
                </div>
              </form>
